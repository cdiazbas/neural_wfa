...
def cder(x, y):
    """
    Computes the derivatives of Stokes vectors (y) with respect to wavelength (x).
    ...
    if y.ndim != 4:
        raise ValueError(f"cder expects 4D input array (N1, N2, N_Stokes, N_wav), got {y.ndim}D")
