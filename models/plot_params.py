...
'axes.linewidth': 1.8,
#   'axes.prop_cycle': cycler('color', sns.color_palette("Set1", 10, desat=0.7).as_hex()) + cycler(alpha=10*[.9]),
#   'axes.prop_cycle': cycler('color', sns.color_palette("Set1", 10).as_hex()) + cycler(alpha=10*[.7]), 
